import sys
from sharuan import Ui_Form
from PyQt5.QtWidgets import QApplication
from PyQt5 import QtWidgets
import re
import threading

class mwindow(QtWidgets.QWidget,Ui_Form):

    def __init__(self,parent=None):
        super(mwindow, self).__init__(parent)
        self.setupUi(self)
        self.pushButton.clicked.connect(self.avlist)

    def avlist(self):
        s=self.textEdit.toPlainText().strip()
        ...
        for i in c:
            ...
            aa = i + ".exe"
            if aa in avList.keys():
                n=aa + ":" + avList[aa]
                self.textEdit_2.append(n)
